...
<style>
.contentarea{width: 100%; margin: 0 auto; box-sizing: border-box;}
.contentarea section{margin-top: 100px; width: 90%;}
...
.contentarea .about ul:nth-of-type(2){overflow: hidden; display: flex; gap: 1.5em;}
.contentarea .about ul li{width: 33.33%;}
.contentarea .about ul li img{width: 100%; border-radius: 50%;}
.contentarea .about .tex{gap: 2em; width: 90%; margin: 0 auto 5%;}
